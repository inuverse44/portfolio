...
├── public/
│   ├── images/posts/       # Blog assets (Directly managed, best practice)
│   ├── favicon.png         # Site favicon
│   ├── robots.txt          # Search engine instructions
│   └── sitemap.xml         # Generated by scripts/generate-sitemap.mjs
├── scripts/                # Utility scripts (e.g., sitemap generator)
├── src/
│   ├── components/         # Atomic Design inspired structure
│   │   ├── atoms/          # Smallest units (Meta, Tag, Button)
│   │   ├── molecules/      # Groups of atoms (Navigation, PostCard, TagList)
│   │   └── organisms/      # Complex components (Header, Footer, PostBody)
│   ├── constants/          # Site-wide configuration (URLs, Titles)
│   ├── lib/                # Shared business logic
│   │   └── posts/          # Markdown parsing, data fetching API
│   ├── pages/              # Next.js routes
│   │   ├── blog.tsx        # Post list with tags and sidebar
│   │   ├── about.tsx       # Author profile
│   │   └── external.tsx    # Recommended links
