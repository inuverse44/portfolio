...
とあります。8ビットRGBカラー成分を整数ピクセルにパックした画像を表すとのことです。詳しくは[Class DirectColorModel](https://docs.oracle.com/javase/8/docs/api/java/awt/image/DirectColorModel.html)も参考にしてください。
